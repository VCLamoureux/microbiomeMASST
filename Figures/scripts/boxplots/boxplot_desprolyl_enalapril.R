...
metadata <- metadata |>
  ...
  dplyr::filter(!filename %in% file_to_exclude) |>
  dplyr::mutate(
...
specified_features <- c("49329","58714","25210","43281","26159","31815")
...
#write_csv(df_melted_plot, "OneDrive-UniversityofCalifornia,SanDiegoHealth/Postdoc_UCSD/Postdoc_projects/Main_project/enalapril_proline_drugmix6.csv")
...
df_melted_plot_1
#ggsave("enalapril_proline.pdf", df_melted_plot_1, width = 5, height = 7, dpi = 900)
